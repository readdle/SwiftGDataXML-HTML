...
private func SplitQNameReverse(_ qname: UnsafePointer<xmlChar>) -> (qname: UnsafeMutablePointer<xmlChar>?, prefix: UnsafeMutablePointer<xmlChar>?) {
...
private func RegisterNamespaces(_ ns: Dictionary<String, String>?, _ xpathCtx: xmlXPathContextPtr, _ nsNodePtr: xmlNodePtr?) {
...
public class GDataXMLNode : Hashable, NSCopying  {
    ...
    var cachedChildren_ : Array<GDataXMLNode>?;
    var cachedAttributes_ : Array<GDataXMLNode>?;
    ...
    public func stringFrom(xmlString chars: UnsafePointer<xmlChar>?) -> String? {
        ...
        var cacheDict : Dictionary<XmlCharKey, String>?;
    ...
    public func qualifiedName() -> String? {
        ...
        if let xmlNode = xmlNode_ {
            ...
            } else if let _ = xmlNode.pointee.ns, let prefix = xmlNode.pointee.ns.pointee.prefix {
                // name of a non-namespace node
                // has a prefix
                withVaList([prefix, xmlNode.pointee.name]) { vaList in
                    var qname: UnsafeMutablePointer<CChar>? = nil
    ...
    public func children() -> Array<GDataXMLNode>? {
        if (cachedChildren_ != nil) {
    ...
    public func nodesFor(XPath xpath: String, namespaces: Dictionary<String, String>?) -> (nodes: Array<GDataXMLNode>?, error: Error?) {
        ...
        var tempDoc : xmlDocPtr? = nil;
        var topParent : xmlNodePtr? = nil;
            ...
            if let xpathCtx = xmlXPathNewContext(safeXmlNode.pointee.doc) {
                ...
                if let xpathObj = xmlXPathEval(xpath, xpathCtx) {
                    ...
                    if let msg = xpathCtx.pointee.lastError.str1 {
                        let errStr = String.init(cString: msg);
...
public class GDataXMLElement : GDataXMLNode {
    ...
    public func namespaces() -> Array<GDataXMLNode>? {
        var array : Array<GDataXMLNode>? = nil;
    ...
    public func elementsFor(name: String) -> Array<GDataXMLNode>? {
    ...
    public func elementsFor(localName: String?, URI: String?) -> Array<GDataXMLNode>? {
    ...
    public func attributes() -> Array<GDataXMLNode>? {
        ...
        if let safeXmlNode = xmlNode_ {
            ...
            attribute.XMLNode()?.withMemoryRebound(to: xmlAttr.self, capacity: 1, { attrPtr in
                ...
                if (oldAttr == nil) {
                    ...
                    var newPropNS : xmlNsPtr? = nil;
                    
                    // if this attribute has a namespace, search for a matching namespace
                    // on the node we're adding to
                    if (attrPtr.pointee.ns != nil) {
                        
                        newPropNS = xmlSearchNsByHref(safeXmlNode.pointee.doc, xmlNode_, attrPtr.pointee.ns.pointee.href);
                        if (newPropNS == nil) {
                            // make a new namespace on the parent node, and use that for the
                            // new attribute
                            newPropNS = xmlNewNs(safeXmlNode, attrPtr.pointee.ns.pointee.href, attrPtr.pointee.ns.pointee.prefix);
                        }
                    }
    ...
    public static func fixDuplicateNamespaces(forNode nodeToFix: xmlNodePtr, graftingToTreeNode graftPointNode: xmlNodePtr, namespaceSubstitutionMap nsMap: inout Dictionary<xmlNsPtr, xmlNsPtr>) {
    ...
    public static func fixUpNamespaces(forNode nodeToFix: xmlNodePtr, graftingToTreeNode graftPointNode:xmlNodePtr, namespaceSubstitutionMap nsMap: inout Dictionary<xmlNsPtr, xmlNsPtr>) {
        ...
        self.fixDuplicateNamespaces(forNode: nodeToFix, graftingToTreeNode:graftPointNode, namespaceSubstitutionMap: &nsMap);
        ...
        if (nodeToFix.pointee.type == XML_ELEMENT_NODE) {
            ...
            while (currChild != nil) {
                self.fixUpNamespaces(forNode:currChild!, graftingToTreeNode: graftPointNode, namespaceSubstitutionMap: &nsMap);
                currChild = currChild!.pointee.next;
            }
            ...
            while (currProp != nil) {
                currProp!.withMemoryRebound(to: xmlNode.self, capacity: 1, { currProp_ in
                    self.fixUpNamespaces(forNode: currProp_, graftingToTreeNode:graftPointNode, namespaceSubstitutionMap: &nsMap);
                })
    ...
    public static func fixUpNamespaces(forNode nodeToFix: xmlNodePtr, graftingToTreeNode graftPointNode: xmlNodePtr) {
        ...
        var nsMap = Dictionary<xmlNsPtr, xmlNsPtr>();
...
public class GDataXMLDocument {
    ...
    public func addStringsCacheToDoc() {
        ...
        cacheDict = Dictionary<XmlCharKey, String>()
    ...
    public func rootElement() -> GDataXMLElement? {
        var element : GDataXMLElement? = nil;
